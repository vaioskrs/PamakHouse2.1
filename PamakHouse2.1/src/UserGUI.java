...
public class UserGUI extends JFrame {
    ...
    public UserGUI(User user, ArrayList<User> allUsers)
    {
        ...
        buttonBack = new JButton("Ðßóù óôï ðáñÜèõñï åéóüäïõ");
        buttonPost = new JButton("Ðüóô");
        sortButton = new JButton("Ôáîéíüìçóç");

        labelRecentPost      = new JLabel("Ðñüóöáôá ðïóô ößëùí");
        labelSuggestedFriend = new JLabel("Ðñïôåéíüìåíïé ößëïé");
